...
int main() {
    ...
    // Converting the edge list graph to an adjacency list graph
    ...
    printf("Bidirectional search on Adjacency List graph:\n");
    bidirectionalSearchAdjList(adjListGraph, src, dest);

    // Free the adjacency list graph nodes
